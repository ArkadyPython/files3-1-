def sorted_union_files(files: list, result_path: str):
    temp_dict = {sum(1 for i in open(one_file, encoding="UTF-8")): one_file for one_file in files}
...
def main():
    ...
    sorted_union_files(files, "itog.txt")
